...
class Map
  ...
  def initialize game
    ...
    @points = []
    @points << Point.new(243,  65, event: Event.new("rosoku.png", game))
    @points << Point.new(321, 125)
    @points << Point.new(382, 166)
    @points << Point.new(442, 217)
    @points << Point.new(492, 262, event: Event.new("iwamiginzan.png", game))
	...
	@points << Point.new(280, 442, event: Event.new("aquas.png", game))
