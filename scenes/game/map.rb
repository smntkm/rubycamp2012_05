...
class Map
  ...
  def initialize
    ...
    @points = []
    @points << Point.new(243,  65, "point.png", event: Event.new("rosoku.png"))
    @points << Point.new(321, 125, "point.png")
    @points << Point.new(382, 166, "point.png")
    @points << Point.new(442, 217, "point.png")
    @points << Point.new(492, 262, "point.png", event: Event.new("iwamiginzan.png"))
    @points << Point.new(559, 210, "point.png")
    @points << Point.new(620, 144, "point.png", event: Event.new("izumotaisha.png"))
    ...
    @points << Point.new(738, 192, "point.png", event: Event.new("tatara.png"))
	@points << Point.new(804, 195, "point.png")
	@points << Point.new(854, 199, "point.png")
	@points << Point.new(908, 200, "point.png", event: Event.new("yasukibushi.png"))
	@points << Point.new(850, 259, "point.png")
	@points << Point.new(792, 302, "point.png", event: Event.new("soroban.png"))
	...
	@points << Point.new( 43, 641, "point.png", event: Event.new("ougai.png"))
	@points << Point.new(104, 588, "point.png")
	@points << Point.new(161, 537, "point.png", event: Event.new("grantowa.png"))
	@points << Point.new(223, 481, "point.png")
	@points << Point.new(280, 442, "point.png", event: Event.new("aquas.png"))
